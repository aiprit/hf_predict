...
df = pd.read_csv('patient_event_data_3hf.csv')
...
# with open("feature_construction_output_50_events_3hf.csv", "w") as f:
with open("feature_construction_output_50_dates_3hf.csv", "w") as f:
    writer = csv.writer(f)
